...
class AdminSignupForm(forms.ModelForm):
    secret_code = forms.CharField(max_length=20, required=True, help_text="HsptlAdmin")
...
#     class Meta:
#         model = models.TreatmentHistory
#         fields = ['patientId', 'assignedDoctorName', 'diagnosis', 'created_date']
#         widgets = {
